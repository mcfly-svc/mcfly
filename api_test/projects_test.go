...
var projectsRunner EntityEndpointRunner

func init() {
	projectsRunner = EntityEndpointRunner{
		apiClient.Projects,
		`{"source_provider": "github", "username": "mikec", "name": "example-1"}`,
		`{"source_provider": "github", "username": "mikec", "name": "example-2"}`,
	}
}
